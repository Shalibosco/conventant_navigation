                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            destination.getLocalizedName(langCode),
                            style: theme.textTheme.titleLarge,
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                          ),
                          Text(
                            _categoryLabel(context, destination.category),
                ...
                Row(
                  ...
                  children: [
                    ...
                    _StatItem(
                      ...
                      value: navProvider.hasRoute
                          ? context.t('nav_route_ready')
                          : context.t('nav_route_loading'),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        AppTheme
                            .cuNavy, // ✅ Swapped to Navy gradient for aesthetics
